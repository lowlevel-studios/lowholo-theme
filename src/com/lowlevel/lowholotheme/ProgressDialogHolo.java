 ...
 */
public class ProgressDialogHolo extends AlertDialogHolo {
    ...
    public ProgressDialogHolo(Context context, int theme) {
        super(context, theme);
        initFormats();
        mContext = context;
    }
    ...
    public static ProgressDialogHolo show(Context context, CharSequence title,
    ...
    public static ProgressDialogHolo show(Context context, CharSequence title,
    	...
    	ProgressDialogHolo dialog = new ProgressDialogHolo(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mProgressDrawable != null) {
        	...
        	setProgressDrawable(getContext().getResources().getDrawable(R.drawable.progress_horizontal_holo_dark));
        }
